...
export const COMMENT_URL = 'http://localhost:9102' + '/comment'
...
export const FIND_ALL_BY_PERSONAL_ID_URL = '/findAllByPersonalId'
export const FIND_ALL_WITHOUT_MANAGER = '/findAllWithoutManager'
export const FIND_ALL_BY_NOT_APPROVE = '/findAllByNotApprove'
export const FIND_ALL_BY_COMPANY_ID_AND_STATUS_PENDING = '/findAllByCompanyIdAndStatusPending'
