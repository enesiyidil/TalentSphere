...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ApiGatewayManagerException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> handleManagerException(ApiGatewayManagerException ex){
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> handleManagerException(MethodArgumentNotValidException ex){
